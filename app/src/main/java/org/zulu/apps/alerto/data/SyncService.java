package org.zulu.apps.alerto.data;
...
import org.zulu.apps.alerto.util.AndroidComponentUtil;
import org.zulu.apps.alerto.util.NetworkUtil;
...
public class SyncService extends Service {
    ...
    public void onCreate() {
        super.onCreate();
        AlertoApplication.get(this).getComponent().inject(this);
    }
